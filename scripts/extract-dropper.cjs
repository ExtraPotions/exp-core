...
const expected = '6f8ddae769f17aecd9cae723d0bc36359e64e06262ee15962782bcd12e8a7dd8';
const expectedCommit = 'f9b2b837c9cb72c6a0d4d3404143f47af9a8d4df';
...
if (digest !== expected) throw new Error('Extraction requires the approved Dropper 3.2.25 install artifact; hash mismatch: ' + digest);
...
const output = '// Generated from the approved Dropper v3.2.25 install artifact. Do not edit.\n' +
...
console.log('Dropper 3.2.25 reference verified: ' + digest);
