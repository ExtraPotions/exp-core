...
<p align="center">
  ...
  <img alt="Version 3.2.17" src="https://img.shields.io/badge/version-3.2.17-22C55E?style=flat-square">
...
ExtraPotions Core supports the shared appearance, menus, diagnostics, and launcher behavior used by ExtraPotions products. It is not an end-user userscript; install the finished product userscripts instead.
